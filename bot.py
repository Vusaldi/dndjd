...
async def start(event):
  await event.reply("**TehlikeTagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'http://t.me/TehlikeTaggerBot?startgroup=a'),
                      Button.url('💬 Sohbet Qrupumuz', 'https://t.me/tehlikesohbet0'),
                      Button.url('🚀 Sahibim', 'https://t.me/Pufff088')]
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @Pufff088 bilgi alabilirsin <<")
